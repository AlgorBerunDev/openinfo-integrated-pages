  ...
  <div v-loading="loading" class="loader">
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <th>{{ $t('message.issuer_percentage_in_affiliated_entity') }}</th>
          <td>{{ data.share_affiliated_entity }}</td>
        </tr>
        <tr>
          <th>{{ $t('message.affiliated_entity_name') }}</th>
          <td>{{ data.name_affiliated_entity }}</td>
        </tr>
        <tr>
          <th>{{ $t('message.affiliated_entity_postal_address') }}</th>
          <td>{{ data.location_affiliated_entity }}</td>
        </tr>
        <tr>
          <th>{{ $t('message.affiliated_entity_percentage_in_issuer') }}</th>
          <td>{{ data.share_emitent }}</td>
        </tr>
        <tr>
          <th>
            {{
...
<script setup>
  ...
  const getFactsById = () => {
    ...
    axios
      .get(`${url}/disclosure/fact21/${id.value}/`, {
        method: 'get',
      })
      .then((response) => {
