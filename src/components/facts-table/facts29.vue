    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ getReorganizationMethod(data.who_declared_invalid) }}</td>
        </tr>
        ...
        <tr>
          ...
          <td>
            {{
              new Date(data.suspension_reason).toLocaleDateString(
                'ru-RU',
                options,
              )
            }}
        ...
        <tr>
          ...
          <td>
            {{
              new Date(data.date_recognition).toLocaleDateString(
                'ru-RU',
                options,
              )
            }}
